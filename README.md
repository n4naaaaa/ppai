...
<head>
  ...
  <title>PONDOK PESANTREN DARUSSALAM 02</title>
  <!-- Bootstrap 4.5 CDN -->
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" />
  <!-- Google Fonts for Islami look -->
  ...
  <style>
    ...
    .navbar-nav .nav-link:hover {
      color: #a68838 !important;
      font-weight: 700;
    }
    /* Hero */
    header.hero {
      position: relative;
      background: url('https://ibb.co/qLp5tVC4') no-repeat center center/cover;
      height: 90vh;
      min-height: 500px;
      display: flex;
      align-items: center;
        ...
        <div class="col-md-4 col-sm-6 mb-4">
            <div class="card shadow-sm">
              <a href="https://ibb.co/gLn9kdfw" target="_blank" rel="noopener noreferrer" title="Musholla">
                  <img src="https://i.ibb.co/pBmwYQMZ/musholla.jpg" alt="musholla" class="img-fluid rounded" />
                </a>
            </div>
        </div>
        <div class="col-md-4 col-sm-6 mb-4">
